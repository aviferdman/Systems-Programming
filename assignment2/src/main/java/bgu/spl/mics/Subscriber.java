...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private HashMap<Class<? extends Message>, Callback> subscriberCallbackHashMap;
    ...
    public Subscriber(String name) {
        super(name);
        subscriberCallbackHashMap = new HashMap<>();
    }

    public Message getRecMsg() {
        return recMsg;
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        subscriberCallbackHashMap.put(type,callback);
     ...
     */
    @Override
    //define the subscribers general run method
    public final void run() {
        initialize();
        while (!terminated) {
            try {
                recMsg = msg.awaitMessage(this);
                Callback v = subscriberCallbackHashMap.get(recMsg.getClass());
                v.call(recMsg);
            } catch (Exception e) {
                terminate();
            }
    ...
    public HashMap<Class<? extends Message>, Callback> getSubscriberCallbackHashMap() {
        return subscriberCallbackHashMap;
    }

    public MessageBroker getMsg() {
        return msg;
    }
    ...
    public void setRecMsg(Message recMsg) {
        this.recMsg = recMsg;
    }
    ...
    public void setSubscriberCallbackHashMap(HashMap<Class<? extends Message>, Callback> subscriberCallbackHashMap) {
        this.subscriberCallbackHashMap = subscriberCallbackHashMap;
    }

    public void setMsg(MessageBroker msg) {
        this.msg = msg;
    }
}
